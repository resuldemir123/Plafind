-- MySQL'deki Veri Sayılarını Kontrol Etme Scripti
-- Bu scripti MySQL Workbench'te veya mysql komut satırında çalıştırın

USE AlanyaBusinessGuide;

SELECT 'MySQL Veri Sayıları' AS DatabaseType;
